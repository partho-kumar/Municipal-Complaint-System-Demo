        ...
        <div className="flex flex-col min-h-screen">
            ...
            <div className="bg-hero relative bg-secondary text-white py-20 lg:py-32">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <h1 class="front_text_head" className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6 leading-tight text-blue-400">
                        স্মার্ট পৌরসভা সুন্দর জীবন
                    </h1>
                    <p class="front_text_sub" className="text-lg md:text-xl text-blue-400 mb-10 max-w-2xl mx-auto">
